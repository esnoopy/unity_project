...
public class door : MonoBehaviour
{
    ...
    public string doorLOpenAnimName, doorLCloseAnimName;
       ...
       //A ray is created which will shoot forward from the player's camera
        ...
        if(Physics.Raycast(ray, out hit, interactionDistance))
        {
            ...
            if (hit.collider.gameObject.tag == "door")
            {
                ...
                GameObject leftDoor = GameObject.Find("Tavern_doorL"); 
                Animator doorLAnim = leftDoor.GetComponent<Animator>();
